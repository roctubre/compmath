...
class TensorMethods:
    """
    Implements two methods to calculate tensors from two matrices
    """
    ...
    def tensor2(A, B, display=False):
        ...
        """
        mat = np.product(TensorMethods.tensor1(A, B), axis=1)
        if display:
            print(mat)
        return mat
...
def main():
    ...
    TensorMethods.tensor1(A, B, True)
    TensorMethods.tensor2(A, B, True)
